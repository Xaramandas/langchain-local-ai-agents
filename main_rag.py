...
# 1. MODELO DE CHAT (Para redigir a resposta)
...
# 2. MODELO DE EMBEDDINGS (Para o FAISS)
...
print(responder("Como devo proceder caso tenha um item roubado como o cartao gold?"))
